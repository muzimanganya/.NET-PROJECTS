    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If String.IsNullOrEmpty(reqDate) Then
                ...
                queryTotal = "SELECT SUM(FLD261-FLD269)  AS 'Total' FROM su.CUSTOM1 WHERE CONVERT(varchar(8), FLD262, 3) = " &
                "(SELECT CONVERT(VARCHAR(8), GETDATE(), 3) AS [DD/MM/YY]) and FLD250=2"

                graph = "SET DATEFIRST 1;SELECT DATENAME(WEEKDAY,FLD262) AS 'Weekday',SUM(FLD261-FLD269) AS 'TotalSales' FROM su.CUSTOM1" &
            ...
            Else
                ...
                Try
                    ...
                    queryTotal = String.Format("SELECT SUM(FLD261-FLD269)  AS 'Total' FROM su.CUSTOM1 WHERE DAY(CONVERT(DATETIME, FLD262, 103)) = " &
                    ...
                    graph = String.Format("SET DATEFIRST 1;SELECT DATENAME(WEEKDAY,FLD262) AS 'Weekday',SUM(FLD261-FLD269) AS 'TotalSales' FROM su.CUSTOM1" &
