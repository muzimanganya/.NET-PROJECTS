...
Public Class Datalayer
    ...
    Public Sub LogException(ex As Exception, dbpath As [String])
        Try
            Using tx As TextWriter = New StreamWriter("C:\inetpub\wwwroot\logs\exceptions.txt", True)
    ...
    Public Sub LogString(s As String)
        Try
            Using tx As TextWriter = New StreamWriter("C:\Documents and Settings\PKariuki\Desktop\logs\trail0001.txt", True)
