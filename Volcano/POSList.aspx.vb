            ...
            If Page.IsPostBack Then
                ...
                For Each item As RepeaterItem In rptPosList.Items
                    ...
                    If chkbx.Checked Then
                        updateQuery = "UPDATE su.DOC SET FLD265=1 WHERE IDDOCUMENT=" + posID
                    Else
                        updateQuery = "UPDATE su.DOC SET FLD265=0 WHERE IDDOCUMENT=" + posID
                    End If
        ...
        Try
            ...
            If btn IsNot Nothing Then
                ...
                If cmd = 1 Then
                    ...
                    Dim updateQuery As String = "UPDATE su.DOC set FLD265=1;"
                    clsDataLayer.executeCommand(updateQuery)
                Else
                    'This is for Cancel All
                    Dim updateQuery As String = "UPDATE su.DOC set FLD265=0;"
                    clsDataLayer.executeCommand(updateQuery)
                End If
            End If
