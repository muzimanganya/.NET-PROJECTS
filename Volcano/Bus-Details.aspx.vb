    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If String.IsNullOrEmpty(reqDate) Then
                ...
                query = "SELECT sl.IDSALE,sp.FLD120+'-'+sp.FLD122 AS 'Route',sl.NAME as 'BusName',sl.Memo AS 'BusMemo',sl.DATE_CREAT,sl.FLD103 AS 'Capacity',sl.FLD163 AS 'Hour',sp.IDRELATION, sp.Marked,sp.FLD120 as 'CityIN',sp.FLD122 as 'CityOut',sp.PRICE,sp.FLD191 as 'ClientCode',sp.FLD111 as 'ClientName'," &
                                    "sp.DISCOUNT,sp.Total,sp.FLD213 AS 'Subscriptiono',sp.DATE_MOD AS 'CreatedOn',sp.FLD123 AS 'CreatedBy',sp.FLD118 AS 'Currency',sl.TotalRWF,sl.TotalBWF as 'TotalFIB',sp.FLD133 as 'Passport'" &
                                        " FROM su.SALES as sl INNER JOIN su.SALES_PROD as sp" &
                                            " ON sl.IDSALE = sp.IDSALE WHERE sp.IDSALE=" + idsale + hideTickets + " AND DAY(sp.FLD108) = DAY(GETDATE()) ORDER BY Route,'CreatedOn'"
            ...
            Else
                ...
                Try
                    ...
                    query = String.Format("SELECT sl.IDSALE,sp.FLD120+'-'+sp.FLD122 AS 'Route',sl.Memo AS 'BusMemo',sl.NAME as 'BusName',sl.DATE_CREAT,sl.FLD103 AS 'Capacity',sl.FLD163 AS 'Hour',sp.IDRELATION, sp.Marked, sp.FLD120 as 'CityIN',sp.FLD122 as 'CityOut',sp.PRICE,sp.FLD191 as 'ClientCode',sp.FLD111 as 'ClientName'," &
                                    "sp.DISCOUNT,sp.Total,sp.FLD213 AS 'Subscriptiono',sp.DATE_MOD AS 'CreatedOn',sp.FLD123 AS 'CreatedBy',sp.FLD118 AS 'Currency',sl.TotalRWF,sl.TotalBWF as 'TotalFIB',sp.FLD133 as 'Passport'" &
                                        " FROM su.SALES as sl INNER JOIN su.SALES_PROD as sp" &
                                            " ON sl.IDSALE = sp.IDSALE WHERE sp.IDSALE=" + idsale + hideTickets + " AND DAY(sp.FLD108)= DAY(CONVERT(DATETIME,'{0}',103)) ORDER BY Route,'CreatedOn'", exactDate)
    ...
    Protected Sub gridViewBuses_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) 'Handles gridViewBuses.RowCreated
        ...
        Try
            ...
            If (strPreviousRowID = String.Empty) AndAlso (DataBinder.Eval(e.Row.DataItem, "Route") IsNot Nothing) Then
                ...
                cell.ColumnSpan = 14 'Here we add number of columns for Bus Details
    ...
    Protected Sub gridViewBuses_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) 'Handles gridViewBuses.RowDataBound
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                'change row to yellow bg when cell is marked
                Dim marked As Boolean = Convert.ToBoolean(DataBinder.Eval(e.Row.DataItem, "Marked"))
                If marked Then
                    e.Row.CssClass = "hiddenRow" 
                End If
        ...
        Catch ex As Exception
            ...
            Catch exx As SqlException
                If Not transaction.Connection Is Nothing Then
                    Console.WriteLine("An exception of type " & exx.GetType().ToString() & _
