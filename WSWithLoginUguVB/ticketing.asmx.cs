...
namespace SynovysWebService
{
    ...
    public class ticketing : System.Web.Services.WebService
    {
        ...
        {
            String PosUser = ticketing.POSUSER;
            ...
            try
            {
                if (!this.Validate(UserName, Password, POSUSER))
                {
        ...
        public System.Xml.XmlElement GetTicket(String UserName, String Password, String dbpath, String Date, String Hour, String CityIN, String CityOut,
            ...
            string hash = "", String pref = "0", String BusType = "EXPRESS", String DocumentID = "")
        {
            String PosUser = ticketing.POSUSER;
            SetDBPath(dbpath);
                    ...
                    try
                    {
                        ...
                        using (reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                if (dbpath.ToLower() == "vbtest" || dbpath.ToLower() == "vburundi")
                                {
                                ...
                                {
                                    rw["SNo"] = reader["PLATENO"].ToString();
                                    rw["DocID"] = DocumentID;
                                }
        ...
        public System.Xml.XmlElement Prebooking(String UserName, String Password, String dbpath, String Date, String Hour, String CityIN, String CityOut,
            String Discount, String Creator, String Name = "", String Firstname = "", String ClientCode = "", String currency = "RWF", String hash = "", String seatNo = "", String BusType = "EXPRESS", String DocumentID = "")
        {
            String PosUser = ticketing.POSUSER;
            SetDBPath(dbpath);
        ...
        [WebMethod(CacheDuration = 1)]
        public System.Xml.XmlElement PullBooking(String UserName, String Password, String dbpath, String Creator, String BookingNo = "0", String hash = "")
        {
            String PosUser = ticketing.POSUSER;
            SetDBPath(dbpath);
        ...
        [WebMethod(CacheDuration = 1)]
        public XmlElement SeatsReport(string UserName, string Password, string dbpath, string Cityin, string CityOut, string Date, string Hour, string BusType = "OT")
        {
            this.SetDBPath(dbpath);
            DataSet set = new DataSet("SeatsReport");
            XmlDocument document = new XmlDocument
            {
                PreserveWhitespace = false
            };
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(string.Format("{1};Initial Catalog={0};User Id=sa;Password={2};", dbpath, server, pass)))
                {
                    ...
                    try
                    {
                        ...
                        DataTable table = new DataTable("Seats");
                        table.Columns.Add("BUSNAME");
                        table.Columns.Add("PSEATSCOUNT");
                        table.Columns.Add("NSEATSCOUNT");
                        table.Columns.Add("PSEATS");
                        table.Columns.Add("NSEATS");
                        table.Columns.Add("TOTALFREE");
                        using (reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                row["PSEATSCOUNT"] = reader["PSEATSCOUNT"].ToString();
                                row["NSEATSCOUNT"] = reader["NORMALCOUNT"].ToString();
                                row["PSEATS"] = reader["PSEATS"].ToString();
                                row["NSEATS"] = reader["NSEATS"].ToString();
                                row["TOTALFREE"] = reader["TOTAL"].ToString();
                                table.Rows.Add(row);
                            }
                        }
                        transaction.Commit();
                    ...
                    {
                        transaction.Rollback();
                        DataTable table2 = new DataTable("Seats");
                        table2.Columns.Add("BUSNAME");
                        table2.Columns.Add("PSEATSCOUNT");
                        table2.Columns.Add("NSEATSCOUNT");
                        table2.Columns.Add("PSEATS");
                        table2.Columns.Add("NSEATS");
                        table2.Columns.Add("TOTALFREE");
                        DataRow row2 = table2.NewRow();
                        row2["BUSNAME"] = '-';
                        row2["PSEATSCOUNT"] = "-";
                        row2["NSEATSCOUNT"] = "-";
                        row2["PSEATS"] = "-";
                        row2["NSEATS"] = "-";
                        row2["TOTALFREE"] = "- System 10 Error" + exception.Message;
                        table2.Rows.Add(row2);
                        set.Tables.Add(table2);
                        this.LogException(exception, dbpath);
                    }
            ...
            {
                if (!set.Tables.Contains("Seats"))
                {
                    DataTable table3 = new DataTable("Seats");
                    table3.Columns.Add("BUSNAME");
                    table3.Columns.Add("PSEATSCOUNT");
                    table3.Columns.Add("NSEATSCOUNT");
                    table3.Columns.Add("PSEATS");
                    table3.Columns.Add("NSEATS");
                    table3.Columns.Add("TOTALFREE");
                    DataRow row3 = table3.NewRow();
                    row3["BUSNAME"] = '-';
                    row3["PSEATSCOUNT"] = "-";
                    row3["NSEATSCOUNT"] = "-";
                    row3["PSEATS"] = "-";
                    row3["NSEATS"] = "-";
                    row3["TOTALFREE"] = "- System 20 Error. " + exception2.Message + " Coming From " + exception2.Source + " And Stack Trace " + exception2.StackTrace;
                    table3.Rows.Add(row3);
                    set.Tables.Add(table3);
                    this.LogException(exception2, dbpath);
                    document.LoadXml(set.GetXml());
