...
Public Class Datalayer
    ...
    Private Database As String = "Volcano"
    ...
    End Sub
    Public Function ReturnConnection() As SqlConnection
    ...
    Public Sub ConnectForProcsAudit()
        Try
            ...
            If ServerName <> "" Then
                myConTwo = Nothing
                myConTwo = New SqlConnection(ConfigurationManager.ConnectionStrings("DatabaseConn").ConnectionString)
    ...
    Public Function ReturnSingleValue(ByVal Selectstmt As String) As String
        Dim myval As String = ""
        Try
            'Using aCon As SqlConnection = ReturnConnection()
    ...
    Public Function ReturnSingleNumeric(ByVal Selectstmt As String) As Double
        Try
            ...
            '    If ds.Tables(0).Rows.Count > 0 Then
            '        myval = Convert.ToDouble(ds.Tables(0).Rows(0).Item(0))
            '    Else
            '        myval = 0
            '    End If
            '    aCon.Close()
    ...
    Public Function ReturnDataTable(ByVal mysql As String) As DataTable
    ...
    Public Sub LogException(ex As Exception, dbpath As [String])
        Try
            Using tx As TextWriter = New StreamWriter(HttpContext.Current.Server.MapPath("~") + "\logs\exceptions.txt", True)
    ...
    Public Sub LogString(s As String)
        Try
            Using tx As TextWriter = New StreamWriter(HttpContext.Current.Server.MapPath("~") + "\logs\trail0001.txt", True)
