            ...
            <div class="cpanel-left">
                ...
                <fieldset id="queryForm" title="New Traffic / Business">
                  <ul class="queryList">
                    ...
                    <li>
                        <asp:Label id="Label1" for="txtPlateNo" title="" runat="server" ClientIDMode="Static">Select Plate Number<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                            <asp:DropDownList ID="txtPlateNo" runat="server" DataSourceID="SQLDATAPLATENOS" DataTextField="PLATENO" DataValueField="PLATENO">
                            </asp:DropDownList>
                            
                            <asp:SqlDataSource ID="SQLDATAPLATENOS" runat="server" 
                              SelectCommand="SELECT [PLATENO] FROM [Vehicles]" ConnectionString="<%$ ConnectionStrings:AppDBContext %>"></asp:SqlDataSource>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Plate Number cannot be empty" ControlToValidate="txtPlateNo" ForeColor="Red">*
                            </asp:RequiredFieldValidator>  
                        </div>
                    </li>
                      <li>
                        <asp:Label id="Label2" for="txtDriver" title="" runat="server" ClientIDMode="Static">Select Driver<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                            <asp:DropDownList ID="txtDriver" runat="server" DataSourceID="SQLDATADRIVERS" DataTextField="DriverName" DataValueField="DriverName">
                            </asp:DropDownList>
                            
                            <asp:SqlDataSource ID="SQLDATADRIVERS" runat="server" 
                              SelectCommand="SELECT [DriverName] FROM [Drivers]" ConnectionString="<%$ ConnectionStrings:AppDBContext %>"></asp:SqlDataSource>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Driver cannot be empty" ControlToValidate="txtDriver" ForeColor="Red">*
                            </asp:RequiredFieldValidator>  
                        </div>
                    </li>
                    <div class="clr">
