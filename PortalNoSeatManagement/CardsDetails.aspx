<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="CardsDetails.aspx.vb" Inherits="CardsDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-subscription">
                <h2>Card Details <asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
    ...
    <div id="element-box">
        <div class="m">
            <div class="cpanel-left" style="width:100% !important">
                <div class="m">
