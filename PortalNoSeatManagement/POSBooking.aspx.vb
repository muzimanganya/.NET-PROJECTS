    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If String.IsNullOrEmpty(reqDate) Then
                ...
                totalTigo = clsDataLayer.ReturnSingleNumeric("SELECT  SUM(TOTAL) from su.SALES_PROD WHERE FLD123='TigoCash'  AND DAY(DATE_MOD) =DAY(GETDATE())  AND MONTH(DATE_MOD) = MONTH(GETDATE()) AND YEAR(DATE_MOD) = YEAR(GETDATE())")
            ...
            Else
                ...
                Try
                    ...
                    totalTigo = clsDataLayer.ReturnSingleNumeric(String.Format("SELECT  SUM(TOTAL) from su.SALES_PROD WHERE FLD123='TigoCash'  AND DAY(DATE_MOD) =DAY(CONVERT(DATETIME,'{0}',103)) AND MONTH(DATE_MOD) =MONTH(CONVERT(DATETIME,'{0}',103)) AND YEAR(DATE_MOD) =YEAR(CONVERT(DATETIME,'{0}',103))", exactDate))
            ...
            Else
                ...
                Try
                    ...
                    json += String.Format("['Tigo Cash',{0}],", totalTigo)
                    ...
                    mys.AppendLine("var options = {title: 'Total Revenue Per Mode',slices : { 1: {offset: 0.2}}};")
