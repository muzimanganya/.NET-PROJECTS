<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Branches.aspx.cs" Inherits="Branches" %> 
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-pos">
                <h2>Branch Sales Report <asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
            </div>
        </div>
    </div> 
    ...
    <div id="element-box">
        <div class="m">
            ...
            <div class="cpanel-left"> 
                ...
                ShowHeader="False">            
                        <Columns>
                             <asp:HyperLinkField   HeaderText="Branch Name" DataNavigateUrlFields="BranchID, ReqDate, EndDate" 
                                  Text="BranchName"  DataTextField="BranchName"  DataNavigateUrlFormatString="Branch-Sales-List.aspx?Branch={0}&requestDate={1}&endDate={2}" />
            ...
            <div class="cpanel-right">
                <div class="pane-sliders2" style="background:white">
                    <div class="panel"> 
                        <h3 style="text-align:center">Best Selling Branches</h3>
                        <div style="width: 100%">
                          <div>
