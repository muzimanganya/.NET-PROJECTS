<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="OtherTicketDetails.aspx.vb" Inherits="OtherTicketDetails" %>
        ...
        <div class="m">
            <div class="cpanel-left">
                ...
                <fieldset id="queryForm" title="Ticket Details">
                    ...
                    <asp:Button ID="btnDeleteTicket" runat="server" Text="Remove Ticket" OnClientClick="JavaScript:alert('Deleting the Ticket. Please wait? \n\nPlease note that any action in this system is logged.')" style="clear:both"/>
