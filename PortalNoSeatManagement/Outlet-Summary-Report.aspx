<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="Outlet-Summary-Report.aspx.vb" Inherits="Outlet_Summary_Report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
    <title>Outlet Summary Report</title>
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-traffic">
                <h2>Outlet Summary Report for <asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
    ...
    <div id="element-box">
        <div class="m">
            <div class="cpanel-left">
                <div class="m">
                    <p><asp:Button ID="exportExcel" runat="server" Text="Export to Excel"  OnClick="exportExcel_Click" />    </p>
                    <asp:UpdatePanel ID="upMainView" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <asp:Repeater ID="rptMasterView" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>  
                                        <td class="center"><asp:literal ID="BusRoute" runat="server" Text=<%# DataBinder.Eval(Container.DataItem, "BusRoute")%> ></asp:literal></td>
                                        <td class="center"><asp:literal ID="TotalTickets" Text='<%# DataBinder.Eval(Container.DataItem, "TotalTickets")%>' runat="server"></asp:literal></td>
                                        <td class="center"><asp:literal ID="TotalBooking" Text='<%# DataBinder.Eval(Container.DataItem, "TotalBooking")%>' runat="server"></asp:literal></td>
                                        <td class="center"><asp:literal ID="TotalPromo" Text='<%# DataBinder.Eval(Container.DataItem, "TotalPromo")%>' runat="server"></asp:literal></td>
                                        <td class="center"><asp:literal ID="TotalPos" Text='<%# DataBinder.Eval(Container.DataItem, "TotalPos")%>' runat="server"></asp:literal></td>
                                        <td style="font-weight:bold;text-align:right;font-style:italic"><asp:literal ID="TotalRWF" Text='<%# DataBinder.Eval(Container.DataItem, "TotalRWF", "{0:n2}")%>' runat="server"></asp:literal></td>
                                        <td style="font-weight:bold;text-align:right;font-style:italic"><asp:literal ID="TotalFIB" Text='<%#  DataBinder.Eval(Container.DataItem, "TotalFIB", "{0:n2}")%>' runat="server"></asp:literal></td>
                                    </tr>
                            </ItemTemplate>
                    ...
                    <Triggers>
                        <%--<asp:PostBackTrigger ControlID="tmrMainView"/>--%>
                            ...
                            <asp:Repeater ID="rptSummary" runat="server">
                                <ItemTemplate>
                                   <div style="float:right;font-size:14px;color:red;font-weight:bolder;">
                                       Total Sales Done On: <i><%# DataBinder.Eval(Container.DataItem, "TDATE")%></i> = FIB <%# DataBinder.Eval(Container.DataItem, "TotalFIB", "{0:n2}")%>
                                       RWF <%# DataBinder.Eval(Container.DataItem, "TotalRWF", "{0:n2}")%></div>
                                </ItemTemplate>
                            </asp:Repeater>
                            <asp:Repeater ID="rptTotalForDay" runat="server">
                                <ItemTemplate>
                                   ...
                                   <div style="float:right;font-size:14px;color:blue;font-weight:bolder;">
                                       Total Sales For: <i><%# DataBinder.Eval(Container.DataItem, "TDATE")%></i> = RWF <%# DataBinder.Eval(Container.DataItem, "TotalRWF", "{0:n2}")%>
                                       FIB <%# DataBinder.Eval(Container.DataItem, "TotalFIB", "{0:n2}")%></div>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ContentTemplate>
                       <Triggers>
