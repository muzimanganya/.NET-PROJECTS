...
Partial Class QueryDB
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack Then
            ...
            Dim targetDate2 As String = Request("ctl00$ctl00$body$content$txtDate2").ToString()
            ...
            If Not String.IsNullOrEmpty(pageToQuery) AndAlso Not String.IsNullOrEmpty(targetDate) Then
                ...
                'Date two specified
                If Not String.IsNullOrEmpty(targetDate2) Then
                    redString = String.Format("{0}?requestDate={1}&endDate={2}", pageToQuery, targetDate, targetDate2)
                End If
        ...
        Else
            ...
            Else
                ddlModules.Items.Add(New ListItem("Day's Planned Traffic", "All-Days--Planned-Traffic.aspx"))
                ddlModules.Items.Add(New ListItem("Branches Report", "Branches.aspx"))
                ...
                ddlModules.Items.Add(New ListItem("User Sales", "User-Sales.aspx"))
                ...
                ddlModules.Items.Add(New ListItem("Deleted Tickets", "RemovedTraffic/RolledBackTickets.aspx"))
