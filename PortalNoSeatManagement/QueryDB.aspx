        ...
        $(function () {
            ...
            $("#ddlModules").change(function () {
                ...
                switch (selectedModule) {
                    ...
                    case "Activity.aspx":
                        $("#piechart").fadeOut('fast');
                        $("#piechart").html("<br /><p>This will show you Activity of Client Codes for a certain day</p><p>It will show you regularly used Client Codes</p>");
                        $("#piechart").fadeIn('slow');
                        break;
                }
            });
                ...
                <fieldset id="queryForm" title="Query The Database">
                  <ul class="queryList">
                    ...
                    <li>
                      ...
                      <li>
                        <asp:Label id="Label1" for="txtDate" title="" runat="server" ClientIDMode="Static">End Date (Optional)<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                            <asp:TextBox ID="txtDate2" runat="server" ClientIDMode="Static" CssClass="required"></asp:TextBox>
                            <asp:CalendarExtender ID="ceDate2" runat="server" TargetControlID="txtDate2" Format="dd/MM/yyyy">
                            </asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Select a Target Date" ControlToValidate="txtDate" ForeColor="Red">*
                            </asp:RequiredFieldValidator>
                        </div>
                    </li>
                    <div class="clr">
