            ...
            <div class="cpanel-left">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="center" style="font-weight:bold;text-align:right;font-style:italic"><%# DataBinder.Eval(Container.DataItem, "TotalFIB", "{0:n2}")%></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </tbody>
                ...
                <div class="m">
                    <asp:Repeater ID="rptSummary" runat="server">
                        <ItemTemplate>
                           <div style="float:right;font-size:14px;color:red;font-weight:bolder;">Total Sales = RWF <%# DataBinder.Eval(Container.DataItem, "TotalRWF", "{0:n2}")%>
