                ...
                <fieldset id="queryForm" title="New Traffic / Business">
                  <ul class="queryList">
                    ...
                    <li>
                      ...
                      <li>
                        <asp:Label id="Label2" for="txtPlateNo" title="" runat="server" ClientIDMode="Static">Select Plate Number<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                            <asp:DropDownList ID="txtPlateNo" runat="server"  DataTextField="PLATENO" DataValueField="PLATENO"  >
                            </asp:DropDownList> 
                        </div>
                    </li>
                      <li>
                        <asp:Label id="Label3" for="txtDriver" title="" runat="server" ClientIDMode="Static">Select Driver<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                            <asp:DropDownList ID="txtDriver" runat="server"  DataTextField="DriverName" DataValueField="DriverName">
                            </asp:DropDownList> 
                        </div>
                    </li> 
                    <li>
                    ...
                    <li>
                        <asp:Label id="lblComment" for="txtComment" title="" runat="server" ClientIDMode="Static">Comment:<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                            <asp:TextBox ID="txtComment" runat="server" Rows="5" Columns="50" 
