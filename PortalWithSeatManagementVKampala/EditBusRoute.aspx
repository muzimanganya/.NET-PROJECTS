                ...
                <fieldset id="queryForm" title="New Traffic / Business">
                  <ul class="queryList">
                    ...
                    <li>
                        ...
                        <li>
                        <asp:Label id="Label1" for="txtMemo" title="" runat="server" ClientIDMode="Static">Track Changes:<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                            <asp:TextBox ID="displayText" runat="server" Rows="5" Columns="50" 
