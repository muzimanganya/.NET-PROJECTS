                    ...
                    <li>
                        ...
                        <div class="fltlft">
                            <asp:DropDownList ID="ddlCityIN" runat="server" CssClass="required" ClientIDMode="Static">
                                <asp:ListItem Text="Kigali1" Value="Kigali1" Selected=True></asp:ListItem>
                                <asp:ListItem Text="Kampala" Value="Kampala"></asp:ListItem> 
                                <asp:ListItem Text="Kampala2" Value="Kampala2"></asp:ListItem>
                                 <asp:ListItem Text="Bujumbura" Value="Bujumbura"></asp:ListItem>                                
                                <asp:ListItem Text="Bujumb" Value="Bujumb"></asp:ListItem>                                
                                <asp:ListItem Text="Kigali" Value="Kigali"></asp:ListItem>
                            </asp:DropDownList>
